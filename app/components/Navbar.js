              ...
              <div className="lg:!flex lg:flex-auto max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                <ul className="lg:flex lg:gap-x-8 max-lg:space-y-2">
                  ...
                  <li className="max-lg:border-b max-lg:py-3">
                    <Link href={'/'} className="hover:text-[#1d294f] uppercase text-[#1d294f] block font-bold text-[15px] from-after">
                      Home
                    </Link>
                  </li>
                  <li className="max-lg:border-b max-lg:py-3">
                    <Link href={'/about'} className="hover:text-[#1d294f] uppercase text-gray-600 block font-bold text-[15px] from-after">
                      About
                    </Link>
                  </li>
                  <li className="group max-lg:border-b max-lg:py-3 relative">
                    <Link href={'#'} className="hover:text-[#1d294f] uppercase text-gray-600 text-[15px] font-bold lg:hover:fill-[#1d294f] block from-after">
                      Service
                      {/* <svg

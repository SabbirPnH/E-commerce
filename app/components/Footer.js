...
const Footer = () => {
    return (
        <section className="pt-16 pb-7 bg-black">
            <div className="mx-auto max-w-7xl px-5 sm:px-20">
                <div className="grid grid-cols-1 max-lg:gap-10 lg:grid-cols-12 lg:divide-x-2 divide-gray-200 pb-10 lg:pb-14 border-b-2 border-gray-200">
                    <div className="lg:col-span-7 pr-9 xl:pr-16">
                        <h5 className="text-lg font-medium text-[#E9FF97] max-md:text-center mb-7">Contact</h5>
                        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-2 pb-12 border-b-2 border-gray-200">
                            <div className="flex flex-col md:flex-row min-[1024px]:flex-col min-[1160px]:flex-row items-center gap-2.5">
                                ...
                                <p className="text-base font-normal text-gray-400">184-A, PnH, Bangladesh.</p>
                            </div>
                           ...
                           <div className="flex flex-col md:flex-row min-[1024px]:flex-col min-[1160px]:flex-row items-center gap-2.5">
                                ...
                                <p className="text-base font-normal text-gray-400 select-all cursor-pointer">+8801873003333</p>
                            </div>
                           </Link>
                          ...
                          <div className="flex flex-col md:flex-row min-[1024px]:flex-col min-[1160px]:flex-row items-center gap-2.5">
                                ...
                                <p className="text-base font-normal text-gray-400 select-all cursor-pointer">pnh@bd.com</p>
                            </div>
                          </Link>
                        </div>
                        <div className="flex flex-col md:flex-row items-center max-lg:justify-between gap-8 lg:gap-12 pt-14">
                            <div className="block">
                                <h6 className="text-lg font-medium text-[#E9FF97] mb-7 max-md:text-center">Pagedone</h6>
                                <ul className="flex flex-col max-md:items-center gap-6">
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 max-md:text-center transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Home</a>
                                    </li>
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 max-md:text-center transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">About</a>
                                    </li>
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 max-md:text-center transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Service</a>
                                    </li>
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 max-md:text-center transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Protfolio
                                        </a></li>
                                        <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 max-md:text-center transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Contact
                                        </a></li>
                                </ul>
                            </div>
                            <div className="block">
                                <h6 className="text-lg font-medium text-[#E9FF97] max-md:text-center mb-7">Services</h6>
                                <ul className="flex flex-col max-md:items-center gap-6">
                                    <li><a href="javascritp:;"
                                        ...
                                        Web Design </a></li>
                                        <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Software
                                        Development</a></li>
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Web
                                        Development</a></li>
                                      
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Ecommerce Website</a></li>
                                   
                                        <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">PHP Laravel Development</a></li>
                                        
                                </ul>
                            </div>
                            <div className="block">
                                <h6 className="text-lg font-medium text-[#E9FF97] max-md:text-center mb-7">Domain & Hosting Services</h6>
                                <ul className="flex flex-col max-md:items-center gap-6">
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Domain Registration</a>
                                    </li>
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">Shared
                                        Hosting</a></li>
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">VPS Hosting</a>
                                    </li>
                                    <li><a href="javascritp:;"
                                        className="text-base font-normal text-gray-600 transition-all duration-300 hover:text-[#A7E6FF] focus-within:outline-0 focus-within:text-[#A7E6FF]">
                                        Cloud Hosting</a></li>
                    ...
                    <div className="lg:col-span-5  lg:pl-9 xl:pl-16 col-start-1 max-lg:row-start-1">
                        ...
                        <h2 className="font-manrope font-semibold text-2xl max-md:text-center leading-9 text-[#fff] mt-9 mb-5">PnH Corporation</h2>
                        <p className="text-base font-normal text-gray-500 max-md:text-center mb-8">PnH BD is a full-fledged software, website and app creation company located in the capital city of Dhaka. PnH is known as Creative Website Development Company of Bangladesh.</p>
                            ...
                            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path
                                        ...
                                        stroke="#A7E6FF" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                        ...
                        <button
                            className="py-2.5 px-7 max-md:w-full max-md:text-center rounded-sm max-md:mx-auto flex items-center justify-center bg-[#A7E6FF] text-base font-semibold text-black mb-8 transition-all duration-500 hover:bg-[#182b50] hover:text-white ">Subscribe</button>
                        <div className="flex items-center max-md:justify-center gap-5">
                            ...
                            <Link target='_blank' href={'https://linkedin.com/company/pnh-corporation'}
                                className="p-2 text-white rounded-full transition-all duration-500 hover:bg-[#A7E6FF] focus-within:bg-[#A7E6FF] focus-within:outline-0 hover:text-black focus-within:text-black">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                    <path fill="currentColor" d="M21.5 0h-19C1.12 0 0 1.12 0 2.5v19C0 22.88 1.12 24 2.5 24h19c1.38 0 2.5-1.12 2.5-2.5v-19C24 1.12 22.88 0 21.5 0zM7.94 20.66h-3.6V9.298h3.6V20.66zm-1.8-13.504c-.99 0-1.798-.808-1.798-1.796 0-.988.808-1.796 1.798-1.796.988 0 1.796.808 1.796 1.796 0 .988-.808 1.796-1.796 1.796zM20.66 20.66h-3.602v-5.34c0-1.28-.024-2.92-1.796-2.92-1.8 0-2.074 1.405-2.074 2.857v5.404h-3.602V9.298h3.5v1.52h.048c.488-.924 1.68-1.897 3.454-1.897 3.698 0 4.38 2.43 4.38 5.592v6.147z" />
                                </svg>
                            ...
                            <Link target='_blank' href={'https://www.facebook.com/pnhitsolution'}
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30">
                                    <path fill="currentColor" d="M24,4H6C4.895,4,4,4.895,4,6v18c0,1.105,0.895,2,2,2h10v-9h-3v-3h3v-1.611C16,9.339,17.486,8,20.021,8 c1.214,0,1.856,0.09,2.16,0.131V11h-1.729C19.376,11,19,11.568,19,12.718V14h3.154l-0.428,3H19v9h5c1.105,0,2-0.895,2-2V6 C26,4.895,25.104,4,24,4z"></path>
                                </svg>
                            </Link>
                        </div>
                    </div>
                ...
                <div className="flex items-center justify-center pt-7">
                    <p className="text-sm font-normal text-gray-500"><a href="#" ></a>
                    Copyright © 2024 All Rights Reserved By PnH Corporation</p>
                </div>
            </div>
        </section>

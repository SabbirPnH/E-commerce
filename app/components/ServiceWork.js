    ...
    <div className=" lg:grid lg:grid-cols-2 lg:gap-8">
      ...
      <div 
       ...
       <div 
            ...
            <p className="text-[17px] text-gray-700 break-all tracking-tight">
            We are committed to providing quality over quantity. Instead of offering plenty of services, we strive to focus on the following web development works to ensure the best quality work and put a smile on your client&aposs face.
            </p>

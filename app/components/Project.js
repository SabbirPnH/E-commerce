...
export default function Project() {
  return (
    ...
    <div>
      ...
      <h2 className=' text-center font-semibold text-[16px]'>WE ARE GOOD AT</h2>
      <h1 className='text-center text-[22px]  sm:text-[32px]  py-2'>BENEFITS OF ECOMMERCE WEBSITE DEVELOPMENT</h1>
      <p className='text-center text-[22px] text-[#182b50]'>WE WILL DO EVERYTHING WE CAN TO MAKE OUR NEXT BEST PROJECT!</p>
      </div>
 <div className="w-full py-10 flex justify-center items-center  dark:bg-white">
      <div className="grid grid-cols-1 sm:grid-cols-2  gap-10 px-5 sm:px-20">
        {data.map((item) => (
          ...
          >
            <div
              className="absolute flex justify-center gap-1 w-10 text-xl font-bold text-center py-1 font-semibold dark:bg-white bg-[#182b50] rounded-sm -top-2 -left-2"
            >

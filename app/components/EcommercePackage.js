...
const EcommercePackage = () => {
  return (
<div>
    <h2 className=" text-[22px] sm:text-[32px] text-[#182b50] text-center font-semibold">Ecommerce Package</h2>
...
<div className="mt-4  sm:mt-10 ">
    <div className="bg-white border-4 border-t-teal-400 border-r-pink-400 border-l-sky-400 border-b-lime-400   rounded text-center  pt-6 pb-8 ">
        ...
        19,990 Taka / $180 USD
            ...
            <span className="text-red-500 text-lg line-through">25,000 Taka / $220 USD</span>
            <hr className="mt-3"/>
        </div>
        ...
        <div class="mt-6">
           ...
           <h2 className="text-center font-bold my-2 border-t border-b cursor-pointer py-2">Read More</h2>
        </div>
        <div className="mt-4">
...
<div className="mt-4  sm:mt-10 ">
    <div className="bg-white border-4 border-t-teal-400 border-r-pink-400 border-l-sky-400 border-b-lime-400   rounded text-center  pt-6 pb-8 ">
        ...
        39,990 Taka / $380 USD
            ...
            <span className="text-red-500 text-lg line-through">50,000 Taka / $450 USD</span>
            <hr className="mt-3"/>
        </div>
...
<div className="mt-4  sm:mt-10">
    <div className="bg-white border-4 border-t-teal-400 border-r-pink-400 border-l-sky-400 border-b-lime-400   rounded text-center  pt-6 pb-8 ">
        ...
        74,990 Taka / $700 USD
            ...
            <span className="text-red-500 text-lg line-through">99,990 Taka / $900 USD</span>
            <hr className="mt-3"/>
        </div>
...
<div className="mt-4  sm:mt-10 ">
    <div className="bg-white border-4 border-t-teal-400 border-r-pink-400 border-l-sky-400 border-b-lime-400   rounded text-center  pt-6 pb-8 ">
        ...
        1,49,990 Taka / $1200 USD
            ...
            <span className="text-red-500 text-lg line-through">2,00,000 Taka / $1900 USD</span>
            <hr className="mt-3"/>
        </div>
...
<div className="mt-4  sm:mt-10 ">
    <div className="bg-white border-4 border-t-teal-400 border-r-pink-400 border-l-sky-400 border-b-lime-400   rounded text-center  pt-6 pb-8 ">
        ...
        2,99,990 Taka / $2700 USD
            ...
            <span className="text-red-500 text-lg line-through">4,99,900 Taka / $4500 USD</span>
            <hr className="mt-3"/>
        </div>

...
export default function Gallery() {
  return (
   <section class="bg-white">
	<div class="py-7 px-5 mx-auto max-w-screen-xl  sm:px-20">
		<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
			<div class="col-span-2 sm:col-span-1 md:col-span-2 bg-[#182B50] h-auto md:h-full flex flex-col">
				<a href="" class="group relative flex flex-col  overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
                    ...
                    />
                    <h3 class="z-10 text-[35px]   text-white  top-0 left-0 p-4 font-bold">Custom Cart <br/><span className='text-[22px]'>Development</span></h3>
                    </div>
				</a>
			</div>

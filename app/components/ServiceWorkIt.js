      ...
      <div>
        <div class="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:ml-[8.75rem] md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
          <div className="">
            ...
            <h2 className=" text-[20px] sm:text-[28px] lg:text-[40px] text-[#182b50] font-semibold">
          ...
          <div class="relative">
            <div class="md:flex items-center md:space-x-4 mb-3">
              ...
              <div class="text-slate-500 ml-14">
                <span class="text-slate-900 font-bold">Brainstorming</span>{" "}
              </div>
            </div>

            <div class="bg-white p-4 rounded border border-slate-200 text-slate-500 shadow ml-14 md:ml-44">
              The first step is to take the projects data & think about to
              manage all aspects of your software assets including maintenance.
              Our skilled personnel along with a high-level look at the client’s
              network and suggestions for strategic direction utilising the
              latest processing software.
            </div>
          </div>
          ...
          <div class="relative">
            <div class="md:flex items-center md:space-x-4 mb-3">
              ...
              <div class="text-slate-500 ml-14">
                <span class="text-slate-900 font-bold">Concept Prototype</span>{" "}
              </div>
            </div>
            ...
            <div class="bg-white p-4 rounded border border-slate-200 text-slate-500 shadow ml-14 md:ml-44">
              ...
              communication services software assets. Our skilled personnel,
              utilising the latest processing software, combined with decades of
              experience. Once the critical situation resolved, work on the ITA
              roadmap resumed.
            </div>
          </div>
          ...
          <div class="relative">
            <div class="md:flex items-center md:space-x-4 mb-3">
              ...
              <div class="text-slate-500 ml-14">
                <span class="text-slate-900 font-bold">Design Layout</span>{" "}
              </div>
            </div>

            <div class="bg-white p-4 rounded border border-slate-200 text-slate-500 shadow ml-14 md:ml-44">
              Start to work on the design taking with collected data, we&aposre
              responsible for our process and results. Skilled personnel,
              utilising the latest processing software, combined with decades of
              experience about the product & competitors offer integral

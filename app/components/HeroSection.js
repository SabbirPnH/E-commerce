...
const HeroSection = () => {
  return (
    <div className='py-10 bg-slate-100'>
      <h2 className='text-[32px] font-semibold px-5 text-center break-all sm:px-20 tracking-widest'>ARE YOU LOOKING FOR THE BEST ECOMMERCE DEVELOPMENT COMPANY FOR MAKING AN ONLINE BUSINESS PLATFORM?</h2>

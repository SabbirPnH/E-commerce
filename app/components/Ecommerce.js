const Ecommerce = () => {
    return (
        ...
        <div class="flex gap-20 bg-white  overflow-hidden items-center justify-start">
    
            <div class="relative w-32 h-32 flex-shrink-0">
                <img class="absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50" loading="lazy" src="/img/api.png"/>
            </div>
    
            <div class="flex sm:flex-col gap-2 py-2">
